...
private:
    ...
    CMouseLeg LForeRight = CMouseLeg('f','l', Lift);//fwd=180 bkwd=0 up=180 down=0
    CMouseLeg LHindLeft = CMouseLeg('h','l', Lift); //fwd=0 bkwd=180 up=0 down=180
    CMouseLeg LHindRight = CMouseLeg('h','l', Lift); //fwd=180 bkwd=0 up=180 down=0
    CSpine Spine = CSpine();
...
private:
    ...
    std_msgs::Float64 LBodyH2;

    std_msgs::Float64 LTail;

    ros::Publisher LElbow_pub;
    ros::Publisher LShoulder_pub;
    ros::Publisher RElbow_pub;
    ros::Publisher RShoulder_pub;
    ros::Publisher LHip_pub;
    ros::Publisher LKnee_pub;
    ros::Publisher RHip_pub;
    ros::Publisher RKnee_pub;
    ros::Publisher LBodyH10_pub;
    ros::Publisher LBodyH1_pub;
    ros::Publisher LBodyH7_pub;

    ros::Publisher LTail21_pub;
    ros::Publisher LTail15_pub;
    ros::Publisher LTail9_pub;
